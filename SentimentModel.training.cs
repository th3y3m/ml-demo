...
namespace MLDemo
{
    ...
    {
        public const string RetrainFilePath =  @"E:\C#\MLDemo\yelp_labelled.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LightGbm(new LightGbmMulticlassTrainer.Options(){NumberOfLeaves=4,NumberOfIterations=3865,MinimumExampleCountPerLeaf=21,LearningRate=0.06758545042667552,LabelColumnName=@"col1",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.99999999,L1Regularization=2E-10,L2Regularization=0.6425177539737811},MaximumBinCountPerFeature=244}))      
